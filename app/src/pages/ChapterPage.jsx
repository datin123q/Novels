...
const ChapterPage = () => {
  ...
  const { posts, post, getPostById, getPosts, deletePost } = usePostStore();
    ...
    <div className="min-h-screen">
      <div className="flex flex-col items-center justify-center pt-24 px-4 mb-10">
        ...
        <AnimatePresence initial={false}>
          {isVisible ? (
            <div className="fixed inset-0 backdrop-blur-md flex justify-center items-center duration-300 z-50">
              <motion.div
                key="edit-profile"
