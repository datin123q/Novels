...
const ProfilePage = () => {
  ...
  const { authUser, onlineUsers,deleteUser } = useAuthStore();
...
const handleDeleteUser = async () => {
  ...
  const success = await deleteUser(userProfile._id);
      ...
      >
        ...
        <div
          className="group absolute z-20
                    ...
                    lg:h-36 lg:w-36 h-28 w-28
                    left-1/2 -translate-x-1/2 top-[13vh]
                    drop-shadow-md ring-milk ring-[3px]"
          style={{
            backgroundImage: `url(${
        ...
        >
          {/* Online status */}
          <div
            className={`absolute rounded-full h-5 w-5 border-2 border-rice
                        right-1 bottom-0 lg:right-4
                        ${
